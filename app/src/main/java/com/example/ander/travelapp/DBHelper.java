...
//    public ArrayList<String> arrayList()
    ...
    private void insertAgentItems(SQLiteDatabase sqLiteDatabase) {
        ArrayList<AgentNameNumObj> arrayInner = new ArrayList();

        arrayInner.add(new AgentNameNumObj("Opodo", "3503883"));
        arrayInner.add(new AgentNameNumObj("GetAFlight", "2627398"));
        arrayInner.add(new AgentNameNumObj("lastminute.com", "3165195"));
        arrayInner.add(new AgentNameNumObj("Bravofly", "2043147"));
        arrayInner.add(new AgentNameNumObj("Fly-Sharp", "2499240"));
        arrayInner.add(new AgentNameNumObj("TravelTrolley", "3943896"));
        arrayInner.add(new AgentNameNumObj("omegaflightstore.com", "3496199"));
        arrayInner.add(new AgentNameNumObj("EmailFlights", "3247564"));
        arrayInner.add(new AgentNameNumObj("travelup", "4061456"));
        arrayInner.add(new AgentNameNumObj("GotoGate", "2628363"));
        arrayInner.add(new AgentNameNumObj("eDreams", "2370315"));
        arrayInner.add(new AgentNameNumObj("STATravel", "3920907"));
        arrayInner.add(new AgentNameNumObj("Lees-Travel", "3146004"));
        arrayInner.add(new AgentNameNumObj("Mytrip", "1963108"));
        arrayInner.add(new AgentNameNumObj("Tripsta", "4056843"));
        arrayInner.add(new AgentNameNumObj("BudgetAir", "3874827"));
        arrayInner.add(new AgentNameNumObj("QatarAirways", "3690449"));
        arrayInner.add(new AgentNameNumObj("CheapOair", "2158117"));
        arrayInner.add(new AgentNameNumObj("wanguk", "2172259"));
        arrayInner.add(new AgentNameNumObj("BritishAirways", "2032127"));
        arrayInner.add(new AgentNameNumObj("EmailFlights", "3247564"));
        arrayInner.add(new AgentNameNumObj("ebookers", "2365707"));
        arrayInner.add(new AgentNameNumObj("UnitedAirlines", "4132306"));
        arrayInner.add(new AgentNameNumObj("Expedia", "4499211"));
        arrayInner.add(new AgentNameNumObj("Despegar", "2261936"));
        arrayInner.add(new AgentNameNumObj("Carlton Leisure", "2142076"));
    ...
    private void insertLocationData(SQLiteDatabase sqLiteDatabase) {
        ...
        arrayList.add(new AirportInformationObj("21", "Sakatoon", "YXE", "NorthAmerica", "Canada"));
        ...
        arrayList.add(new AirportInformationObj("57", "Athens-Intl", "ATH", "Europe", "Greece"));
